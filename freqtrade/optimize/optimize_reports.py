...
from freqtrade.data.metrics import (calculate_cagr, calculate_calmar, calculate_csum,
                                    ...
                                    calculate_max_drawdown, calculate_sharpe, calculate_sharpe_new, calculate_sortino)
...
def generate_strategy_stats(pairlist: List[str],
    ...
    strat_stats = {
        ...
        'sharpe_new': calculate_sharpe_new(results, min_date, max_date, start_balance),
...
def text_table_add_metrics(strat_results: Dict) -> str:
    if len(strat_results['trades']) > 0:
        ...
        metrics = [
            ...
            ('Sharpe New', f"{strat_results['sharpe_new']:.2f}" if 'sharpe_new' in strat_results else 'N/A'),
